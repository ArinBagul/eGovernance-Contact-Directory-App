...
const ContactCard = () => {
  ...
  const toggleFavorite = async () => {
    try {
      ...
      if (isFavorite) {
        favorites = favorites.filter((favContact) => favContact !== contact);
      } else {
      ...
      // console.log("Contact added to favourites");
    } catch (error) {
  ...
  return (
    <View style={style.cardContainer}>
      <Text style={style.nameTxt}>{contact.name}</Text>
      <Text style={style.designationTxt}>{contact.designation}</Text>

      <View style={style.bottomContainer}>
        <Text style={style.position}>{contact.position}</Text>
